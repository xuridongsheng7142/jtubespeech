...
task=vi
data_path=/home/xudong.wang/xdwang/corpus/jtubespeech/vi2
nj_video=4
...
python3 tools/data/get_Vietnamese_data_mul.py $data_path/data/wavs_16k.list $data_path/data/txt.list $data_path/data/ref.txt $data_path/wavs_split
